...
export const en = {
  ...
  inputInherit: 'Inherit the route default',
  inputText: 'Text only',
  inputTextImage: 'Text + images',
  fieldCustomYaml: 'Custom value — edit settings.yaml',
  modelReasoning: 'Reasoning',
  modelReasoningLevels: 'Reasoning levels',
  reasoningInherit: 'Inherit the catalog',
  reasoningDisabled: 'Not supported',
  reasoningCustom: 'Custom levels…',
  reasoningOffHint: 'Offer “off”: no reasoning parameter is sent',
  modelReasoningEmpty: 'Choose at least one reasoning level besides off.',
  addModel: 'Add model',
  ...
  fetchSearch: 'Filter models…',
  fetchInvert: 'Invert',
  fetchNoMatch: 'No models match this filter.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  fieldCustomYaml: '自定义值——请编辑 settings.yaml',
  modelReasoning: '推理',
  modelReasoningLevels: '推理档位',
  reasoningInherit: '跟随目录',
  reasoningDisabled: '不支持推理',
  reasoningCustom: '自定义档位…',
  reasoningOffHint: '提供 off：不发送推理参数',
  modelReasoningEmpty: '至少选择一个 off 以外的推理档位。',
  addModel: '添加模型',
  removeModel: '删除模型',
